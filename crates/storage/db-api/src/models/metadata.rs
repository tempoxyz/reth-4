...
impl StorageSettings {
    ...
    pub const fn v2() -> Self {
        Self { storage_v2: true, use_hashed_state: false }
    }
...
impl Serialize for StorageSettings {
        ...
        S: serde::Serializer,
    {
        ...
        let mut s = serializer.serialize_struct("StorageSettings", 2)?;
        s.serialize_field("storage_v2", &self.storage_v2)?;
        s.serialize_field("use_hashed_state", &self.use_hashed_state)?;
        s.end()
    }
}

/// Custom deserialization: accepts both the new shape (`storage_v2`, `use_hashed_state`)
...
impl<'de> Deserialize<'de> for StorageSettings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        if value.get("storage_v2").is_some() {
            ...
            Ok(Self { storage_v2: new.storage_v2, use_hashed_state: new.use_hashed_state })
        } else {
            ...
            Ok(Self { storage_v2: is_v2, use_hashed_state: legacy.use_hashed_state })
        }
    }
}
